        ...
        function E() {
            ...
            d.setAttribute("type", e), f = c.appendChild(d), f ? (g = 0, function() {
                if (typeof f.GetVariable != a) {
                    ...
                    return g++, setTimeout(arguments.callee, 10), void 0;
                        ...
                        if (g = P(d))
                            if (!S(m[c].swfVersion) || y.wk && y.wk < 312)
                                if (m[c].expressInstall && H()) {
                                    for (h = {}, h.data = m[c].expressInstall, h.width = g.getAttribute("width") || "0", h.height = g.getAttribute("height") || "0", g.getAttribute("class") && (h.styleclass = g.getAttribute("class")), g.getAttribute("align") && (h.align = g.getAttribute("align")), i = {}, j = g.getElementsByTagName("param"), k = j.length, l = 0; k > l; l++)
        ...
        return function() {
            ...
            embedSWF: function(c, d, e, f, g, h, i, j, k, l) {
                ...
                y.w3 && !(y.wk && y.wk < 312) && c && d && e && f && g ? (U(d, !1), B(function() {
                    ...
                    if (S(g))
                        s = L(n, p, d), n.id == d && U(d, !0), m.success = !0, m.ref = s;
                    else {
                        if (h && H())
                            return n.data = h, I(n, p, d, l), void 0;
                        U(d, !0)
                    }
                    l && l(m)
                })) : l && l(m)
            ...
            getQueryParamValue: function(a) {
                var c,
                    d,
                    b = i.location.search || i.location.hash;
                if (b) {
...
!function() {
    if (window.WEB_SOCKET_FORCE_FLASH)
        ...
        if (window.MozWebSocket)
            return window.WebSocket = MozWebSocket, void 0
    }
    var a;
    return a = window.WEB_SOCKET_LOGGER ? WEB_SOCKET_LOGGER : window.console && window.console.log && window.console.error ? window.console : {
        ...
        var b,
            c;
        if ("readyState" in a && (this.readyState = a.readyState), "protocol" in a && (this.protocol = a.protocol), "open" == a.type || "error" == a.type)
        ...
        if (!WebSocket.__initialized) {
            if (WebSocket.__initialized = !0, WebSocket.__swfLocation && (window.WEB_SOCKET_SWF_LOCATION = WebSocket.__swfLocation), !window.WEB_SOCKET_SWF_LOCATION)
                return a.error("[WebSocket] set WEB_SOCKET_SWF_LOCATION to location of WebSocketMain.swf"), void 0;
        ...
        return setTimeout(function() {
            var b,
                c;
            try {
                for (b = WebSocket.__flash.receiveEvents(), c = 0; c < b.length; ++c)
